export default {
  ...
  description:
    "Mostly used to craft advanced weapons. Can be recycled into crafting materials.",
  ...
  used_in: [
    ...
    },
    {
      item: {
        ...
        item_type: "Weapon",
        description:
          "Semi-automatic shotgun with good bullet spread but sharp falloff",
      },
      quantity: 2,
    },
    {
      item: {
        ...
        item_type: "Weapon",
        description:
          "Has large ammo capacity, but is only accurate while crouched. ",
      },
      quantity: 2,
    },
    {
    ...
    },
    {
      item: {
        ...
        item_type: "Weapon",
        description:
          "A scoped bolt-action sniper rifle with reliable damage output and accuracy.",
      },
      quantity: 1,
    },
    {
  ...
  recycle_from: [
    ...
    },
    {
      item: {
        ...
        item_type: "Recyclable",
        description:
          "A salvaged component from a Bastion unit. Can be recycled into crafting materials.",
      },
      quantity: 2,
    },
    {
  ...
  dropped_by: [
    {
      id: "47b60a18-9e67-4a88-a876-2c1a5d63b4c5",
      arc: {
        id: "queen",
